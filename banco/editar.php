...
echo '<label>Placa</label><input type="text" id="txtPlaca" name="txtPlaca"
value="' . $row['placa'] . '" readonly="readonly"/><br /><br />
<label>Fabricante</label>
<input type="text" id="txtFabricante" name="txtFabricante"
value="' . $row['fabricante'] . '" autofocus="autofocus" />
<br /><br /> <label>Marca</label>
<input type="text" id="txtMarca" name="txtMarca" value="' . $row['marca'] . '" />
<br /><br /> <label>Ano</label>
<input type="number" id="txtAno" name="txtAno" value="' . $row['ano'] . '"/>
<br /><br /> <label>Cor</label>
<input type="text" id="txtCor" name="txtCor" value="' . $row['cor'] . '" />
</fieldset><br />
<fieldset> <legend>Dados do Cliente</legend>
<label>Nome</label> <input type="text" id="txtNome" name="txtNome"
value="' . $row['nome'] . '" /> <br /><br />
<label>Idade</label>
...
name="txtTelefone" value="' . $row['telefone'] . '" />
</fieldset><br /><br />';
}
