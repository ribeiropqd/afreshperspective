...
<head>
    ...
    <link rel="stylesheet" href="stylecss/1home.css">
</head>
...
<?php
    $galleryItems = [
        ["img" => "imagens/casamento.jpg", "alt" => "casamento", "caption" => "CASAMENTO"],
        ["img" => "imagens/riodejaneiro.jpg", "alt" => "paisagens", "caption" => "PAISAGENS"],
        ["img" => "imagens/pqd.jpg", "alt" => "aleatorio", "caption" => "DIVERSOS"],
        ["img" => "imagens/formatura.jpg", "alt" => "formaturas", "caption" => "FORMATURAS"],
    ]; ?>
        ...
        <ul class="list-group list-group-horizontal">
            <?php foreach ($galleryItems as $item): ?>
                <li class="list-group-item no-background">
                    <a class="nav-link active" href="4servicos.php">
                        <figure>
