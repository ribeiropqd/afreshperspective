...
<head>
    ...
    <link rel="stylesheet" href="stylecss/2qs.css">
</head>
<body style="background-image: url(imagens/fundopag2.jpg);">

<nav class="navbar navbar-expand-lg bg-body-dark">
  <div class="container-fluid">
    <a class="navbar-brand text-light" href="#">AFS</a>
...
<div class="text">
    <p>Olá, tudo bem? Meu nome é Victor Ribeiro, tenho 23 anos, sou universitário e estou cursando Análise e Desenvolvimento de Sistemas (ADS) na Estácio, e este site é o meu projeto para esse semestre, um projeto inspirado em uma empresa video/filmmaker, que está disposta a registrar todo e qualquer momento que o cliente julgue necessário, desde um passeio, ou até mesmo um casamento, o que o cliente julgar necessário, estaremos lá! Não perca tempo, faça já o seu cadastro e marque uma data em nossa agenda! <p>
</div>
